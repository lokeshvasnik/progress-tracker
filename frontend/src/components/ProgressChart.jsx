...
const ProgressChart = ({ progressPercent, formattedData }) => {
    ...
    return (
        <div className="border border-slate-300 rounded-md p-5 my-10 dark:text-white">
            <div>
            ...
            {
                formattedData.length === 0 ? <p>No Data Available!</p> : <ResponsiveContainer width="100%" height={200}>
